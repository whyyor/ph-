        ...
        <div className="relative bg-white shadow-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div className="relative overflow-hidden bg-sky-700 py-10 px-6 sm:px-10 xl:p-12">
              ...
              <a href="https://maps.google.com/?q=Plot%20No.7.Goyal%20House.Patel%20Nagar.22%20Godam.%2C%20%0AJaipur%2C%20%0ARajasthan%2C%20%0A302006">
                <p className="mt-6 max-w-3xl text-base text-sky-50">
                  Plot No.7.Goyal House.Patel Nagar.22 Godam.
                  <br />
                  Jaipur, Rajasthan
                  <br />
                  302006
              ...
              <dl className="mt-8 space-y-6">
                ...
                <dd className="flex text-base text-sky-50">
                  <EnvelopeIcon
                    ...
                    aria-hidden="true"
                  />
                  <span className="ml-3">support@bottled.design</span>
                </dd>
              </dl>
